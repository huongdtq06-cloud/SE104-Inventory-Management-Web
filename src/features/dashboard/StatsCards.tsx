import { Activity, AlarmCheck, AlertTriangle, DollarSign, Package, StoreIcon, TrendingUp, Users } from 'lucide-react';
...
const toneMap: Record<DashboardStat['tone'], { color: string; subColor: string }> = {
